...
const SlideInFromLeft: React.FC<{ children: React.ReactNode; delay?: number; className?: string }> = ({ children, delay = 0, className = "" }) => {
    const [isVisible, setIsVisible] = useState(false);
            ...
            >
                ...
                <div className="mt-3 flex justify-between items-center">
                    ...
                    <SlideInFromLeft delay={500}>
                        <span
                            id="prompt-counter"
                            className={`text-sm transition-colors duration-200 ${remaining < 50

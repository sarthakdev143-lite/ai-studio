...
const StatusMessage = ({ generationState }) => {
...
const RequirementChecker = ({ hasImage, hasPrompt }) => (
  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-4">
    <div className={`flex items-center gap-2 p-3 rounded-lg border transition-all duration-200 ${
      hasImage 
        ...
        <div className="flex gap-4 mb-6">
          <ScaleIn className="flex-1">
            <button
              ...
              className={`w-full py-6 px-8 rounded-xl font-semibold text-xl flex items-center justify-center gap-3 transition-all duration-300 transform focus:outline-none focus:ring-4 focus:ring-orange-500/30 ${
                canGenerate
